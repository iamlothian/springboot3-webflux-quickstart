...
public abstract class AbstractValidationHandler<T, U extends Validator> {
    ...
    protected Mono<ServerResponse> onValidationErrors(Errors errors, T invalidBody, final ServerRequest request) throws ResponseStatusException {
        throw new ResponseStatusException(HttpStatus.BAD_REQUEST, errors.getAllErrors().stream()
